...
#### 工作原理
用户的信息存在归属地的**位置归属寄存器**中，其他地方的访问**位置寄存器**在用户到来期间请求信息，等用户离开后删除。手机发请求，附近**基站**的天线收到移动终端的请求后向**移动交换机MSC**发请求查找被呼叫方的
### 5G与物联网
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk1MDk4ODY3LC03MzQwMTU3NjQsMTI5Nj

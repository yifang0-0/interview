...
# 第二章 自动识别与RFID应用技术
**RFID**:利用无线射频信号空间耦合方式，实现无接触的标签信息自动传输与识别技术。
## 2.1 RFID基本工作原理
**标签结构** 天线+电路+RFID芯片
**电磁学原理** 电磁波与电磁波谱；法拉第**电磁感应定律**实验；电磁场、**近场效应**与无限传播
**RFID标签工作原理** 无源RFID（被动）+有源RFID（主动）+半主动
无源：读写器传递能量，rfid标签收到的能量转换为电能，激活芯片，并将芯片的nen ![enter image description here](http://m.qpic.cn/psc?/V10Fll0B0p55hf/gWShryPLAbNNMut8n7qrsKyYJMxnSfaKIrheTUsXW7Os1Hrct1ho**0BITPwOtjUbNQ0Fg4KcF9t1yxC4edx5Yyl7toBp8l5D4nmikSWIRM!/b&bo=XAQ3BAAAAAARF0s!&rf=viewer_4&t=5)
...
### 无线传感器特点 *
- 网络规模：大小与应用有关
- 自组织网络：节点互相的邻居关系无法预先知道、节点位置不嫩预先设定
- 拓扑结构的动态变化：主要限制**电源有限**，需要新节点及时补充，要求有重构能力
- 以数据为中心：如何**设计拓扑**连接地点不同的节点；如何**分配IP地址**方便用户识别
### 无线传感器结构 *
**节点类型**：传感器节点、汇聚节点、管理节点
...
## 5.1计算机网络技术的研究与发展
### ARPANET研究
arpanet是一个典型的广域网，它的研究成果证明了分组交互理论的正确性，也展现计算机网络广阔的应用前景。
### TCP/IP协议的基本概念
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MTIyMjU4MywzNzEwMDU2MzMsOTM3ND
AwNjk2XX0=
-->
...
#### 工作原理
用户的信息存在归属地的**位置归属寄存器**中，其他地方的访问**位置寄存器**在用户到来期间请求信息，等用户离开后删除。手机发请求，fu'ji**基站**
### 5G与物联网
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyOTQzMTg4NTUsLTczNDAxNTc2NCwxMj
k2MDkwMDEyLDE1MzU1MDIzMzksMzcxMDA1NjMzLDkzNzQwMDY5
Nl19
-->
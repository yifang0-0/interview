...
#### 工作原理
用户的信息存在归属地的**位置归属寄存器**中，其他地方的访问**位置寄存器**在用户到来期间请求信息，等用户离开后删除。s
### 5G与物联网
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU4MTUzMDMzOSwtNzM0MDE1NzY0LDEyOT
YwOTAwMTIsMTUzNTUwMjMzOSwzNzEwMDU2MzMsOTM3NDAwNjk2
XX0=
-->